...
\begin{document}
\center{\Huge Hongyu Wang} 

\center{\small \textbf{Address:} 72 Bayswater ave., Richmond Hill, Ontario, Canada L4E4E6}

\ \\

\begin{tabular*}{7.5in}{l@{\extracolsep{\fill}}r}
\textbf{Email}: hongyu.wang@mail.utoronto.ca & \textbf{Cell}: 647-667-2368\\ 
\textbf{Github}: github.com/hongyu-wang
\end{tabular*}
\\
